...
class RolloutStorage(object):
    def __init__(self, num_steps, num_processes, obs_shape, action_space, recurrent_hidden_state_size, obs_dtype=None):
        self.obs = torch.zeros(num_steps + 1, num_processes, *obs_shape, dtype=obs_dtype)
